...
<center>
 <table>
     <H1 style="color: yellowgreen">DOWNLOADS</H1>         
              <tr style="background-color: steelblue;font-size: 15px;color: #666666">
        <td>FILENAME</td><td>USERNAME</td>
        <td>DOWNLOAD TIME</td>
    </tr>
    <%
...
%>
    ...
    <TR>
        <td><%=rt.getString("filename")%></td><td><%=rt.getString("name")%></td><td><%=rt.getString("time")%></td>
<!--        <td><a href="down.jsp?" style="color: coral">Download</a></td>   -->
    </TR>
<%
}
%>
